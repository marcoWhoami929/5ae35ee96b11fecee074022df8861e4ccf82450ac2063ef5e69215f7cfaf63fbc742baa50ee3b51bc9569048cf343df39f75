!(function (modules) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    function _inherits(subClass, superClass) {
      ...
      (subClass.prototype = Object.create(superClass && superClass.prototype, {
        ...
        superClass &&
          (Object.setPrototypeOfdispatchAsync
            ? Object.setPrototypeOf(subClass, superClass)
            : (subClass.__proto__ = superClass));
    }
    exports.__esModule = !0;
      ...
      Finder = (function () {
        ...
        return (
          ...
          (Finder.prototype.addHits = function (p) {
            var info = this.map[
                _Utils2.default.lowerBound(this.map, { offset: p }, function (
                  a,
                  b
                ) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var _libs = __webpack_require__(0),
      _Utils = __webpack_require__(4),
      _Utils2 = _interopRequireDefault(_Utils);
    (_libs.PDFJS.workerSrc = (window.PDFJS_LOCALE
      ? PDFJS_LOCALE
      : {
          pdfJsWorker: "views/plugins/3dflipbook/js/pdf.worker.js",
          pdfJsCMapUrl: "cmaps/",
        }
    ).pdfJsWorker),
      (_libs.PDFJS.cMapUrl = (window.PDFJS_LOCALE
        ? PDFJS_LOCALE
        : {
            pdfJsWorker: "views/plugins/3dflipbook/js/pdf.worker.js",
            pdfJsCMapUrl: "cmaps/",
      ...
      Binder = (function () {
        function Binder(visual, p) {
          ...
          "" !== p.cover.binderTexture &&
            this.visual.textureLoader.load(p.cover.binderTexture, function (
              texture
            ) {
      ...
      Book = (function (_THREE$EventDispatche) {
        function Book(visual, sheets, pageCallback, props) {
          ...
          return (
            ...
            (_this.binds.onReleaseCallback = _this.onReleaseCallback.bind(
              _this
            )),
                      ...
                      _this4.hoverInfo ||
                        ...
                        !(function () {
                          ...
                          if (
                            ...
                            var sheetBlocks = [
                                _this4.leftCover,
                              ].concat(_this4.sheetBlocks, [_this4.rightCover]),
      ...
      BookController = (function (_Controller) {
        ...
        return (
          ...
          (BookController.prototype.goToPage = function (page) {
            var _this6 = this;
            this.p.rtl && (page = 12 - 1 - page);
            var pageNum = Math.max(Math.min(page, 12 - 1), 0);
            this.state.activeSide = (pageNum + 1) % 2;
            var target = Math.max(Math.min(page - 1 + (page % 2), 12 - 1), 0),
            ...
            if (target != current) {
              ...
              0 === target
                ? ((cv = -1), (target += 1), ++covs)
                : target === 12 - 1 && ((cv = 1), (target -= 2), ++covs),
                target - current &&
          ...
          (BookController.prototype.getPage = function () {
            ...
            return page
              ? Math.min(this.book.getPage() + this.state.activeSide, 12 - 1)
              : 0;
          }),
      ...
      PageManager = (function () {
        ...
        return (
          ...
          (PageManager.prototype.isSinglePage = function (o) {
            return this.p.singlePage || !o.n || o.n === 12 - 1;
          }),
          ...
          (PageManager.prototype.loadPredictedPages = function () {
            ...
            for (
              ...
              var p = _ref7;
              p < 12 && !this.pageCache.get(p) && this.load(void 0, p);
            }
          }),
  ...
  function (module, exports) {
    ...
    (FullScreen._hasWebkitFullScreen = !!document.webkitCancelFullScreen),
      ...
      (FullScreen._hasMsFullscreen = !!document.documentElement
        .msRequestFullscreen),
      ...
      VisualWorld = (function (_THREE$EventDispatche) {
        ...
        return (
          ...
          (VisualWorld.prototype.processGeometry = function (
            ...
            var indexedBufferGeom = this.createIndexedBufferGeometryFromGeometry(
              geometry
            );
            return this.mapIndices(bufGeometry, indexedBufferGeom);
          }),
          (VisualWorld.prototype.createIndexedBufferGeometryFromGeometry = function (
            geometry
          ) {
            for (
              var numVertices = geometry.vertices.length,
                ...
                indices = new (3 * numFaces > 65535
                  ? Uint32Array
                  : Uint16Array)(3 * numFaces),
                i = 0;
              i < numVertices;
              i++
            ) {
